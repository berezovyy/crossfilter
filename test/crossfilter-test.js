  ...
  "group": {
    ...
    "dispose": {
      ...
      "removes reference to group from dimension": function() {
        ...
        // Mock original dispose method to count invocations
        // Job for spy library like sinon, but it is not used here
        group.dispose = function() {
          disposeCount += 1;
          return originalGroupDispose.apply(this, arguments);
        };
        group.dispose();
        dimension.dispose();
